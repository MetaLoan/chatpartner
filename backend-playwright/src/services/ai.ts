...
2. 保持一致：你之前的观点要延续，不要自相矛盾
3. 换个话题或角度：如果你已经连续说了同一个币种/话题超过2次，请换一个币种或话题聊！不要一直重复同一个内容
4. 自然表达：像真人聊天一样，不要说"根据上述"、"我觉得"等生硬开头
5. 连贯完整：用1-3句话表达一个完整的观点，语义要连贯
6. 融入氛围：根据你的人设风格，自然地参与讨论
7. 实时数据仅供参考，不要每次都提价格，偶尔聊聊别的

现在，用你的风格说点什么（注意不要重复之前说过的话题）：`
          }
        ];
